#
#  Be sure to run `pod spec lint ZZCarouselSwift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "The simplest shuffling, hope is helpful for all developers.The depth of support for custom cell.support swift 4.2"
  ...
  s.author             = { "glianze" => "glianze@163.com" }
  # Or just: s.author    = "glianze"
  # s.authors            = { "glianze" => "glianze@163.com" }
  # s.social_media_url   = "http://twitter.com/glianze"
